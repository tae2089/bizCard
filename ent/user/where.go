...
func ModifiedDate(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func ModifiedDateEQ(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldModifiedDate), v))
	})
}
...
func ModifiedDateNEQ(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func ModifiedDateIn(vs ...time.Time) predicate.User {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ModifiedDateNotIn(vs ...time.Time) predicate.User {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ModifiedDateGT(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func ModifiedDateGTE(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func ModifiedDateLT(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func ModifiedDateLTE(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
// HasBizCards applies the HasEdge predicate on the "biz_cards" edge.
func HasBizCards() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(BizCardsTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, BizCardsTable, BizCardsColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasBizCardsWith applies the HasEdge predicate on the "biz_cards" edge with a given conditions (other predicates).
func HasBizCardsWith(preds ...predicate.BizCard) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(BizCardsInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, BizCardsTable, BizCardsColumn),
		)
